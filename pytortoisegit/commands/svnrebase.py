"""commands/svnrebase.py —— /command:svnrebase（svn rebase (git-svn)）。"""
...
@register("svnrebase")
def svnrebase(ctx: CommandContext):
    ...
    dlg.set_label("git svn rebase")
    def _bg():
        r = repo.runner.run("svn", *"rebase".split())
