"""commands/svnignore.py —— /command:svnignore（svn create-ignore (git-svn)）。"""
...
@register("svnignore")
def svnignore(ctx: CommandContext):
    ...
    dlg.set_label("git svn create-ignore")
    def _bg():
        r = repo.runner.run("svn", *"create-ignore".split())
